...
class Storage extends Equatable {
  ...
  factory Storage.fromJson(Map<String, dynamic> json) {
    return Storage(
      isGenerateUniqueFilePath: json['isGenerateUniqueFilePath']
          .toString()
          .contains('true'),
    );
  }
...
class Settings extends Equatable {
  ...
  factory Settings.fromJson(Map<String, dynamic> json) {
    return Settings(
      ...
      enableEngineVinDetection: json['enableEngineVinDetection']
          .toString()
          .contains('true'),
      ...
      enableClaimMeClassifyResult: json['enableClaimMeClassifyResult']
          .toString()
          .contains('true'),
      enableCheckSameCarWhenCallEngine: json['enableCheckSameCarWhenCallEngine']
          .toString()
          .contains('true'),
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (enableSsoAdminUser != null) 'enableSsoAdminUser': enableSsoAdminUser,
    if (enableEngineVinDetection != null)
      'enableEngineVinDetection': enableEngineVinDetection,
    if (enableOcrValuation != null) 'enableOcrValuation': enableOcrValuation,
    if (storage != null) 'storage': storage?.toJson(),
    if (disableAssessmentBox != null)
      'disableAssessmentBox': disableAssessmentBox,
    if (enableRecreateEvent != null) 'enableRecreateEvent': enableRecreateEvent,
...
class ValueMe extends Equatable {
  ...
  factory ValueMe.fromJson(Map<String, dynamic> json) {
    return ValueMe(
      ...
      isEnableTrackCodebookChanges: json['isEnableTrackCodebookChanges']
          .toString()
          .contains('true'),
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (enabledDailyReport != null) 'enabledDailyReport': enabledDailyReport,
...
class UserInfo extends Equatable {
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (passwordLastUpdated != null) 'passwordLastUpdated': passwordLastUpdated,
